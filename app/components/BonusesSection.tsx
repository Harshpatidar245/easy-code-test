...
const bonuses: BonusItem[] = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8">
        <path
          d="M12 15c4 0 7-1.5 7-4V7c0-2.5-3-4-7-4S5 4.5 5 7v4c0 2.5 3 4 7 4z"
          fill="#fff"
          opacity="0.25"
          stroke="#fff"
          strokeWidth="1.5"
        />
        <path
          d="M5 11v3c0 2.5 3 4 7 4s7-1.5 7-4v-3"
          stroke="#fff"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
    ...
    logo: (
      <svg viewBox="0 0 40 24" className="h-6">
        <text
          ...
          fill="#1a1a2e"
        >
          <tspan fill="#e63946">t</tspan>
          <tspan fill="#1a1a2e">cs</tspan>
        </text>
      </svg>
    ),
  },
...
const BonusCard = ({ icon, title, desc }: BonusItem) => (
  <div className="flex items-start gap-5 bg-white rounded-3xl px-8 py-10 shadow-sm border border-purple-50 group hover:shadow-xl transition-all duration-500">
    <div
      className="flex-shrink-0 w-16 h-16 rounded-2xl flex items-center justify-center p-3 transform group-hover:scale-110 transition-transform duration-500 shadow-md"
      style={{ background: "#7c5cbf" }}
    >
      {icon}
    </div>
    <div className="flex flex-col justify-center">
      <p className="text-xl font-extrabold leading-tight text-gray-900 whitespace-pre-line mb-3 tracking-tight">
        {title}
      </p>
...
export default function BonusesSection() {
  return (
    <section className="bg-white overflow-hidden">
      <div className="max-w-[1840px] mx-auto px-4 my-20 sm:px-6 lg:px-10"
      style={{
            background: "linear-gradient(135deg, #fdfcff 0%, #faf9ff 100%)",
          }}>
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 tracking-tight leading-tight">
              ...
              <span className="text-purple-600">Rs. 10,500</span>
            </h2>
          ...
          <div className="flex flex-col items-center gap-10">
            <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-8 px-4">
              {companies.map((c, i) => (
                <div
                  key={i}
                  className="flex items-center justify-center w-46 h-12 
